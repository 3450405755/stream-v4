...
public class Constant {
    ...
    public static final String TOPIC_DB = "topic_log5";
    ...
    public static final String HBASE_NAMESPACE = "dim_to_hbases";
    ...
    public static final String DORIS_DATABASE = "stream-v4";
}
