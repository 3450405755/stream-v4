...
import com.hwq.bean.TableProcessDwd;
import com.hwq.until.JdbcUtil;
...
/**
 * @Package com.hwq.retail.v1.realtime.dwd.BaseDbTableProcessFunction
 * @Author hu.wen.qi
 * @Date 2025/5/4 11:40
 * @description:
 */
...
public class BaseDbTableProcessFunction extends BroadcastProcessFunction<JSONObject, TableProcessDwd, Tuple2<JSONObject, TableProcessDwd>> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        List<TableProcessDwd> tableProcessDwdList
                = JdbcUtil.queryList(mySQLConnection, "select * from dev_realtime_v7_wenqi_hu.table_process_dwd", TableProcessDwd.class, true);
