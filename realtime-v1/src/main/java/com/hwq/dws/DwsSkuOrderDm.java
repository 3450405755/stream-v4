...
/**
 * @Package com.hwq.dws.DwsSkuOrder
 * @Author com.hwq
...
public class DwsSkuOrderDm {
    ...
    public static void main(String[] args) {
        ...
        DataStreamSource<String> kafkaRead = KafkaUtil.getKafkaSource(env, "dwd_trade_order_detail","a2");
//        kafkaRead.print();
...
//        kafkaRead.print();
        ...
        SingleOutputStreamOperator<JSONObject> filterDs =
                distinctDs.keyBy(o->o.getString("user_id")).filter(new FilterBloomDeduplicatorFunc(1000000, 0.01));
                ...
                AsyncDataStream.unorderedWait(filterDs,
                        ...
                        new RichAsyncFunction<JSONObject, JSONObject>() {
                            ...
                            public void asyncInvoke(JSONObject data, ResultFuture<JSONObject> resultFuture) throws Exception {
                                ...
                                JSONObject dimAsync = HBaseUtil.readDimAsync(hbaseCon, "dim_to_hbases", "dim_sku_info", skuId);
                                if (dimAsync != null) {
