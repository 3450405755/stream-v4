...
/**
 * @Package com.hwq.dws.ikfenci.function.IntervalJoinUserInfoLabelProcessFunc3
 * @Author hu.wen.qi
 * @Date 2025/5/14 21:46
 * @description: 1
 */
public class IntervalJoinUserInfoLabelProcessFunc3 extends ProcessJoinFunction<JSONObject, JSONObject, JSONObject> {
    @Override
