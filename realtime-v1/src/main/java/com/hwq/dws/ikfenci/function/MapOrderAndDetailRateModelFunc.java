...
import com.hwq.bean.DimSkuInfoMsg;
...
public class MapOrderAndDetailRateModelFunc extends RichMapFunction<JSONObject,JSONObject> {
    ...
    public MapOrderAndDetailRateModelFunc(List<DimBaseCategory> dimBaseCategories, double timeRate, double amountRate, double brandRate) {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        String querySkuSql = "select sku_info.id as skuid,      \n" +
                ...
                "from dev_realtime_v6_wenqi_hu.sku_info              \n" +
                "join dev_realtime_v6_wenqi_hu.spu_info              \n" +
                "on sku_info.spu_id = spu_info.id       \n" +
                "join dev_realtime_v6_wenqi_hu.base_trademark        \n" +
                "on dev_realtime_v6_wenqi_hu.spu_info.tm_id = dev_realtime_v6_wenqi_hu.base_trademark.id";
