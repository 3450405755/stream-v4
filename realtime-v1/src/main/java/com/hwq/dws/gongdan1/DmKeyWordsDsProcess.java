...
//        env.getCheckpointConfig().setCheckpointStorage("hdfs://cdh01:8020/flink/checkpoints/dws-logs");
        ...
        DataStreamSource<String> kafkaRead = KafkaUtil.getKafkaSource(env, "topic_log","a1");
...
//distinctDs.print();
       ...
       // finalKeyWordDs.map(o->o.toJSONString()).addSink(KafkaUtil.getKafkaSink("dm_keyword_final"));
